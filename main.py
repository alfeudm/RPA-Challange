from rpaframework.browser import Browser
...
class NewsExtractor:
    ...
    def open_website(self, url):
        ...
        assert self.browser.element_exists("//input[@name='query']"), "Search input field not found"
    ...
    def extract_news(self):
        ...
        if self.category:
            ...
            assert self.browser.element_exists(f"//a[contains(text(), '{self.category}')]"), f"News category '{self.category}' not found"
