...
<keywordspec name="RPA.HTTP" type="LIBRARY" format="REST" scope="GLOBAL" generated="2024-04-05T12:30:44+00:00" specversion="5" source="./RPA/HTTP.py" lineno="71">
...
<arguments repr="alias, url, headers={}, cookies={}, client_certs=None, timeout=None, proxies=None, verify=False, debug=0, max_retries=3, backoff_factor=0.1, disable_warnings=0, retry_status_list=[], retry_method_list=['OPTIONS', 'DELETE', 'PUT', 'HEAD', 'GET', 'TRACE']">
...
<arg kind="POSITIONAL_OR_NAMED" required="false" repr="retry_method_list=['OPTIONS', 'DELETE', 'PUT', 'HEAD', 'GET', 'TRACE']">
<name>retry_method_list</name>
<default>['OPTIONS', 'DELETE', 'PUT', 'HEAD', 'GET', 'TRACE']</default>
</arg>
</arguments>
...
<arguments repr="alias, url, auth, headers={}, cookies={}, timeout=None, proxies=None, verify=False, debug=0, max_retries=3, backoff_factor=0.1, disable_warnings=0, retry_status_list=[], retry_method_list=['OPTIONS', 'DELETE', 'PUT', 'HEAD', 'GET', 'TRACE']">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="alias">
<name>alias</name>
</arg>
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="url">
...
<arguments repr="alias, url, headers={}, cookies={}, auth=None, timeout=None, proxies=None, verify=False, debug=0, max_retries=3, backoff_factor=0.1, disable_warnings=0, retry_status_list=[], retry_method_list=['OPTIONS', 'DELETE', 'PUT', 'HEAD', 'GET', 'TRACE']">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="alias">
<name>alias</name>
</arg>
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="url">
